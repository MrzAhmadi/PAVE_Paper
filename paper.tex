...
After the downloaded configuration list occupied about \textbf{5 MB} on the host machine storage, a \textbf{30-second} test by PAVE was run on all target configurations to determine which configurations are reachable by PAVE, and \textbf{1,451} were confirmed at the end.
